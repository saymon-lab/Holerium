...
export default function ContactButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[100] flex items-center gap-3 bg-[#25D366] text-white px-5 py-3 md:px-7 md:py-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.3)] hover:bg-[#20ba5a] transition-all no-underline group"
    >
      ...
      <div className="w-8 h-8 md:w-10 md:h-10 bg-white/20 rounded-full flex items-center justify-center pointer-events-none group-hover:rotate-12 transition-transform">
